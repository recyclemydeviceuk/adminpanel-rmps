    ...
    <div>
      ...
      <div className="rounded-xl border border-[#e8eaed] overflow-hidden">
        ...
        <div className="grid grid-cols-12 gap-3 px-4 py-2.5 bg-[#f8fafc] text-[10px] uppercase tracking-[0.06em] font-semibold text-[#5f6368]">
          <div className="col-span-4">Repair Type</div>
          <div className="col-span-3">Price (£)</div>
          <div className="col-span-3">Was Price (£)</div>
          ...
          <div key={row.repairTypeId} className="grid grid-cols-12 gap-3 px-4 py-3 border-t border-[#f3f4f6] items-center">
            ...
            <div className="col-span-3">
              <input
                ...
                placeholder="—"
                className="w-full rounded-lg border border-[#e8eaed] bg-white px-3 py-2 text-[13px] text-[#5f6368] placeholder:text-[#d1d5db] focus:outline-none focus:ring-2 focus:ring-red-600 focus:border-transparent"
              />
            </div>
