...
const INITIAL_FAQS: FaqEntry[] = [
  ...
  { id: 'faq-002', question: 'What parts do you use for repairs?', answer: 'We use high-quality, rigorously tested replacement parts for all our repairs. Every screen, battery, and component is tested to ensure the best performance and longevity for your device.', category: 'Repairs', isActive: true, sortOrder: 2 },
